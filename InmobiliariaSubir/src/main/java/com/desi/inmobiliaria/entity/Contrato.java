...
public class Contrato {
    ...
    @Max(value = 36, message = "La duración de los contratos tiene un máximo de 36 meses.")
    ...
    public void agregarCambioEstado(EstadoContrato nuevoEstado) {
        HistorialEstadoContrato historial = new HistorialEstadoContrato(this, nuevoEstado);
